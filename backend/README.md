...
## Project Structure
    ...
    ├── testapiautocatalog_109379  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109379`
...
2. Clone this repo and `cd testapiautocatalog_109379`
